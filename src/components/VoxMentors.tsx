export const VoxMentors = () => {
  ...
  const content = {
    ...
    mentor_1_description_3: "Cofundador da Eteg e da Escola em Movimento, adquirida pelo grupo Arco Educação (NYSE: ARCO).",
    ...
    mentor_2_description_2: "Mentor de Negócios e Carreiras no G4 Educação desde 2019, já impactou mais de 200 empresários.",
            ...
            >
               <div className="flex flex-col sm:flex-row gap-6">
                <div className="flex-shrink-0">
                  <div className="w-48 h-48 rounded-2xl overflow-hidden shadow-vox-card">
                    <img 
                      src={mentor.image} 
                      alt={mentor.name}
