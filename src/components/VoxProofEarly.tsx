...
export const VoxProofEarly = () => {
  ...
  const content = {
    ...
    proof_testimonial_1:
      "Depois do Vox, consegui estruturar meu financeiro e hoje tenho previsibilidade no faturamento.",
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
            {content.proof_title.split("Vox")[0]}
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-300 text-sm italic mb-3">
                  {/* ✅ usa <q> para evitar no-unescaped-entities */}
                  <q>{content.proof_testimonial_1}</q>
                </p>
        ...
        <div className="text-center">
          <Button variant="vox" size="lg" onClick={scrollToForm}>
            {content.general_cta}
          </Button>
        </div>
      </div>
