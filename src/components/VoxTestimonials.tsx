...
function TestimonialCard({
  ...
  // ✅ Hook chamado no topo do componente (fora do map)
  ...
  return (
    ...
    >
      ...
      {/* ❌ aspas literais -> ✅ <q> sem disparar react/no-unescaped-entities */}
...
export const VoxTestimonials = () => {
  ...
  const content = {
    testimonials_title:
      "Empresários já estão transformando seus negócios com a Vox",
    testimonials_subtitle:
      "Empresários que já passaram pela Vox e estão colhendo os resultados:",
    testimonial_1_name: "Francisco Lemos",
    testimonial_1_company: "CEO – Frota Car & WG Barbearia",
    testimonial_1_quote:
      "O Vox Elite chegou exatamente no momento em que precisávamos. Um treinamento empresarial completo, que está impulsionando a evolução das nossas empresas.",
    testimonial_1_photo_url: "",
    testimonial_2_name: "Leonardo & Carla",
    testimonial_2_company: "CEOs – Avitex Aviamentos",
    testimonial_2_quote:
      "O Vox Elite veio para fortalecer ainda mais as empresas da nossa região, agregando valor real. Ele soma em todas as áreas do negócio: gestão, finanças e planejamento.",
    testimonial_2_photo_url: "",
    testimonial_3_name: "Cléa Silva",
    testimonial_3_company: "CEO Ondas Kids",
    testimonial_3_quote:
      "Muitas vezes ficamos tão presos à rotina que esquecemos de enxergar novas oportunidades. Esse evento é uma chance real de aprender, na prática, o que é gerir uma empresa. Estarei presente com certeza.",
    ...
    <section className="py-20 bg-vox-darker">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            {content.testimonials_title.split("Vox")[0]}
            <span className="vox-gradient-text">Vox</span>
          </h2>
          <p
            ref={subtitleRef.ref}
